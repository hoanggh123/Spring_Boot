	...
	<div class="container">
		<div class="row">
			<div class="top-left col-sm-10">
				<div class="showroom">
					<i class="icofont-google-map"></i> <span class="shooroom-title">90
						Trần Bá Giao,Phường 5,Gò Vấp,TPHCM</span>
				</div>
				<div class="hotline">
					<i class="icofont-google-map"></i> <span class="hotline-title">0941383007</span>
				</div>
			</div>
			<div class="top-right col-sm-2">
				<div class="icons">
					<i class="icons-title icofont-facebook"></i>
				</div>
				<div class="icons">
					<i class="icons-title icofont-instagram"></i>
				</div>
				<div class="icons">
					<i class="icons-title icofont-twitter"></i>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="user row col-sm-2">
					...
					%>
					<a class="user-item col-sm-6" href="#">Hi ${user.email } </a>
					...
					<div class="user-cart col-sm-2">
						<span class="cart-amount"></span> <a href="shopping"><i
				...
				<div class="row container-fluid">
					<div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
						<ul class="navbar-nav">
							...
							<li class="nav-item dropdown"><a class="nav-link"
								href="category"> <i class="icofont-bag"></i> Sản phẩm
							</a></li>
							<li class="nav-item dropdown"><a class="nav-link" href="#">
									<i class="icofont-letterbox"></i> BLOGS
							</a></li>
							<li class="nav-item dropdown"><a class="nav-link" href="#">
