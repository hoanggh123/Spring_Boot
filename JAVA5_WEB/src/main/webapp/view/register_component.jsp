...
<html  lang="vn">
  ...
  <form *ngIf="!showLogin" #sellerSignUp="ngForm"
    (ngSubmit)="signUp(sellerSignUp.value)"
    action="common-form">
    <div class="form-Up_signUp ">
      <div class="row_signUp">
        <h4 class="information_signUp">
          Thông tin khách hàng
        </h4>
        <div class="form-control_signUp">
          <div class="control-input_signUp">
            <p class="control-item_signUp">Họ:*</p>
            <input class="input-form_signUp" type="text" name="phone" id=""
              placeholder="Họ...">
          </div>
          <div class="control-input_signUp">
            <p class="control-item_signUp">Tên:*</p>
            <input class="input-form_signUp" type="text" name="pass" id=""
              placeholder="Tên...">
          </div>
          <div class="control-input_signUp">
            <p class="control-item_signUp">Email:*</p>
            <input class="input-form_signUp" type="text" ngModel name="email"
              id=""
              placeholder="Email...">
          </div>
          <div class="control-input_signUp">
            <p class="control-item_signUp">Điện thoại:*</p>
            <input class="input-form_signUp" type="number" ngModel name="phone"
              id=""
              placeholder="Điện thoại...">
          </div>
          <div class="control-input_signUp">
            <p class="control-item_signUp">Ngày sinh:*</p>
            <input class="input-form_signUp" type="date" name="" id=""
          ...
          <div class="control-input_signUp">
            ...
            <input class="input-form_signUp" type="text" name="" id=""
          ...
          <div class="control-input_signUp">
            ...
            <input class="input-forms_signUp" type="text" name="" id=""
      ...
      <div class="row_signUp">
        ...
        <div class="form-control_signUp">
          <div class="control-input_signUp">
            ...
            <input class="input-forms_signUp" type="password" ngModel
              name="pass"
              id=""
          ...
          <div class="control-input_signUp">
            ...
            <input class="input-forms_signUp" type="password" name="" id=""
